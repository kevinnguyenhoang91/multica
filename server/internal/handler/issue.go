...
func (h *Handler) QuickCreateIssue(w http.ResponseWriter, r *http.Request) {
	...
	task, err := h.TaskService.EnqueueQuickCreateTask(r.Context(), wsUUID, requesterUUID, agentUUID, squadUUID, prompt, projectUUID, parentIssueUUID, attachmentIDs, useSandbox)
	if err != nil {
