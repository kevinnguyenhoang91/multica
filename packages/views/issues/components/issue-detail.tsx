      ...
      <div>
        ...
        {commentAttachmentsOpen && (
          <div className="pl-2 space-y-2">
            {commentLinks.otherLinks.length === 0 && commentAttachments.images.length === 0 && commentAttachments.otherFiles.length === 0 ? (
              <p className="text-xs text-muted-foreground px-2">{t(($) => $.detail.comment_attachments_empty)}</p>
            ) : (
              <>
                {commentLinks.otherLinks.length > 0 && (
                  <div className="space-y-1">
                    <p className="px-2 text-[11px] text-muted-foreground">{t(($) => $.detail.comment_attachments_links)}</p>
