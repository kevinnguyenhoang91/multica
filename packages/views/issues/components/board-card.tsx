...
export const BoardCardContent = memo(function BoardCardContent({
  ...
  return (
    <div className="rounded-lg border-[0.5px] border-border bg-card py-3 px-2.5 shadow-[0_3px_6px_-2px_rgba(0,0,0,0.02),0_1px_1px_0_rgba(0,0,0,0.04)] transition-[border-color,box-shadow,background-color] group-hover/card:shadow-sm group-data-[popup-open]/card:border-accent group-data-[popup-open]/card:bg-accent">
      {/* Row 1: Identifier */}
