...
const TAB_LABEL_KEY: Record<DetailTab, "activity" | "tasks" | "instructions" | "skills" | "environment" | "mcp" | "custom_args"> = {
  activity: "activity",
  tasks: "tasks",
 ...
 *   - Instructions / Skills / Env / MCP / Custom Args — four editing surfaces.
 *
